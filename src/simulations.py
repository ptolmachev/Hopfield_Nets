import numpy as np
import pickle
from src.Hopfield_net import Hopfield_network,Continuous_HN, random_state, introduce_random_flips
...
file_name = f'flips_and_patterns_Continuous_HN_{rule}{sc_or_not}_{num_neurons}.pkl'
...
for n_p in range(1,num_of_patterns+1):
    ...
    for n_f in range(1,num_of_flips+1):
        ...
        for r in range(num_repetitions):
            HN = Continuous_HN(num_neurons=num_neurons, alpha = 0.1, slope = 3, p=0.5)
